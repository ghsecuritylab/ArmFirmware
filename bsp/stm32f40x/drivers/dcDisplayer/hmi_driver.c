...
void HistoAddFloat(uint16 screen_id,uint16 control_id,float data)
{
	unsigned char buf[4];
	rec rectemp;
	rectemp.a=data;
	...
	HistoDataAdd(screen_id,control_id,&buf[0],4);
}
void HistoDataAdd(uint16 screen_id,uint16 control_id,uint8 *pData,uint16 nDataLen)
{
	BEGIN_CMD();
	TX_8(0xB1);
	TX_8(0x60);
...
void HistoEnable(uint16 screen_id,uint16 control_id)
{
	BEGIN_CMD();
	TX_8(0xB1);
	TX_8(0x61);
...
void HistoDisable(uint16 screen_id,uint16 control_id)
{
		BEGIN_CMD();
	TX_8(0xB1);
	TX_8(0x61);
...
void HistoRangeSet(uint16 screen_id,uint16 control_id, uint32 rMax, uint32 rMin)
{
	BEGIN_CMD();
	TX_8(0xB1);
	TX_8(0x64);
